...
class FeatureExtraction:
    ...
    def WebsiteTraffic(self):
        try:
            rank = BeautifulSoup(urllib.request.urlopen(r"http://data.alexa.com/data?cli=10&dat=s&url=" + url).read(), "xml").find("REACH")['RANK']
            if (int(rank) < 100000):
                return 1
            return 0
        except :
    ...
    def PageRank(self):
        try:
            prank_checker_response = requests.post(r"https://www.checkpagerank.net/index.php", {"name": self.domain})
